...
{
    [ColorUsage(true, true)] [Tooltip("The color of the primitive. Supports transparent colors.")]
    public Color Color;
    ...
    public override void Decompile(ref GameObject gameObject, SchematicBlockData block, Transform parent)
    {
        ...
        PrimitiveComponent primitiveComponent =
            Create<PrimitiveComponent>($"Assets/Resources/Blocks/Primitives/{primitiveType}.prefab");
