...
{
    [Serializable]
    [Node("Player/Condition", "", "HAS EFFECT")]
    public sealed class HasEffectNode : ConditionNode
    {
        public override NodeType NodeType { get; } = NodeType.ConditionHasEffect;
        ...
        protected override void OnDefinePorts(IPortDefinitionContext context)
        {
            ...
            context.AddInputPort<PlayerType>(Constants.IN_PLAYER_PORT_NAME)
                ...
                .Build();
            context.AddInputPort<EffectType>(Constants.IN_VALUE_PORT_NAME)
